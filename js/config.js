materialAdmin
    .config(function ($stateProvider, $urlRouterProvider){
        ...
        $stateProvider
            ...
            .state ('app.product.product-main', {
            url: '/product-main',
            templateUrl: 'views/products/product-main.html'

        })

            .state ('app.product.product-delivery', {
            url: '/product-delivery',
            templateUrl: 'views/products/product-delivery.html'
        })

            .state ('app.product.product-extra', {
            url: '/product-extra',
            templateUrl: 'views/products/product-extra.html'
            ...
            .state ('app.delivery', {
            url: '/delivery',
            templateUrl: 'views/stock/delivery.html'


        })
            .state ('app.inventory-check', {
            url: '/inventory-check',
            templateUrl: 'views/stock/inventory-check.html'
            ...
            url: '/reports/stock',
            templateUrl: 'views/reports/stock.html'
